...
train.set_window(start="1-4-2013",end="30-8-2014")
test.set_window(start="1-9-2014",end="30-9-2014") # to change to 5 house# to change to 5 house
...
top_5_train_elec = train_elec.submeters().select_using_appliances(type=['kettle','fridge','microwave','dish washer'])
...
def predict(clf, test_elec, sample_period, timezone):
    ...
    for i, chunk in enumerate(test_elec.mains().load(ac_type='active',sample_period=sample_period)):
        ...
        for meter in test_elec.submeters().select_using_appliances(type=['kettle','fridge','microwave','dish washer']).meters:
